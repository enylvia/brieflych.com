...
export default async function SourcesPage({
  ...
  return (
    <>
      ...
      <div className="mt-6">
        {sources.length === 0 ? (
          <div className="mb-6 rounded-2xl border border-slate-200 bg-white/90 px-4 py-3 text-sm text-slate-600 shadow-[0_16px_30px_-24px_rgba(11,28,48,0.18)]">
            ...
            <div className="overflow-hidden rounded-2xl bg-[#eff4ff] p-2">
              ...
              <div className="space-y-1.5">
                {sources.map((source, index) => (
                  <div
                    key={source.id}
                    className="admin-card-hover grid grid-cols-1 gap-3 rounded-lg bg-white px-3 py-3 shadow-[0_14px_28px_-22px_rgba(11,28,48,0.3)] motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-2 lg:grid-cols-[1.5fr_0.95fr_0.95fr_0.75fr]"
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between gap-3 lg:block">
                      ...
                      <span className="inline-flex rounded-lg bg-[#eef3ff] px-2 py-0.5 text-[11px] font-medium text-slate-600">
